...
export const removeFurnitureFromBasket = id => dispatch => {
	dispatch({
		type: REMOVE_FURNITURE_FROM_BASKET,
		payload: id
	})
}
...
export const basketCheckout = furniture => () => {
	alert(JSON.stringify(furniture))
}